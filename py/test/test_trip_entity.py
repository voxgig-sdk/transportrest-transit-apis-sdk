    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TRANSPORTREST_TRANSIT_APIS_TEST_TRIP_ENTID JSON to run live")
        client = setup["client"]
        ...
        trip_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(trip_ref01_data_dt0_loaded))
...
def _trip_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("TRANSPORTREST_TRANSIT_APIS_TEST_TRIP_ENTID"))
