# TransportrestTransitApis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TransportrestTransitApisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TransportrestTransitApisSDK(...) and TransportrestTransitApisSDK.test(...) become
#      TransportrestTransitApisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "transportresttransitapis_sdk"
_SDK_CLASS = "TransportrestTransitApisSDK"
