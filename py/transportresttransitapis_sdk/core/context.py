...
from transportresttransitapis_sdk.core.helpers import get_ctx_prop, to_map
...
class TransportrestTransitApisContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TransportrestTransitApisControl()
        ...
        if isinstance(sp, TransportrestTransitApisSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TransportrestTransitApisResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TransportrestTransitApisResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TransportrestTransitApisOperation({})
    ...
    def make_error(self, code, msg):
        return TransportrestTransitApisError(code, msg, self)
