...
from transportresttransitapis_sdk.utility import register

# Load features
from transportresttransitapis_sdk.feature.base_feature import TransportrestTransitApisBaseFeature
from transportresttransitapis_sdk.features import _has_feature, _make_feature
...
class TransportrestTransitApisSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TransportrestTransitApisUtility()
    ...
    def get_utility(self):
        return TransportrestTransitApisUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TransportrestTransitApisSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Arrival(self, data=None) -> "ArrivalEntity":
        ...
        from transportresttransitapis_sdk.entity.arrival_entity import ArrivalEntity
    ...
    def Departure(self, data=None) -> "DepartureEntity":
        ...
        from transportresttransitapis_sdk.entity.departure_entity import DepartureEntity
    ...
    def Journey(self, data=None) -> "JourneyEntity":
        ...
        from transportresttransitapis_sdk.entity.journey_entity import JourneyEntity
