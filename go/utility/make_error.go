...
import "github.com/voxgig-sdk/transportrest-transit-apis-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.TransportrestTransitApisError{
	...
	if se, ok := err.(*core.TransportrestTransitApisError); ok {
		sdkErr.Code = se.Code
	}
