...
type TransportrestTransitApisSDK struct {
	Mode     string
...
func NewTransportrestTransitApisSDK(options map[string]any) *TransportrestTransitApisSDK {
	sdk := &TransportrestTransitApisSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *TransportrestTransitApisSDK) OptionsMap() map[string]any {
...
func (sdk *TransportrestTransitApisSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TransportrestTransitApisSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TransportrestTransitApisSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TransportrestTransitApisSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TransportrestTransitApisSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TransportrestTransitApisSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TransportrestTransitApisSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TransportrestTransitApisSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TransportrestTransitApisSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TransportrestTransitApisSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TransportrestTransitApisSDK {
	...
	sdk := NewTransportrestTransitApisSDK(sdkopts)
	sdk.Mode = "test"
