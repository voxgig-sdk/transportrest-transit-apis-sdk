...
The Golang SDK for the TransportrestTransitApis API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/transportrest-transit-apis-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/transportrest-transit-apis-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/transportrest-transit-apis-sdk/go=../transportrest-transit-apis-sdk/go
```
...
slice):
    ...
    arrival, err := client.Arrival(nil).List(map[string]any{/* fields */}, nil)
    if err != nil { /* handle */ }
    // arrival is the returned record
...
```
github.com/voxgig-sdk/transportrest-transit-apis-sdk/go/
...
The root package (`github.com/voxgig-sdk/transportrest-transit-apis-sdk/go`) re-exports everything needed
