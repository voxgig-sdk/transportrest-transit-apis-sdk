...
type ArrivalEntity struct {
	name    string
	client  *core.TransportrestTransitApisSDK
...
func NewArrivalEntity(client *core.TransportrestTransitApisSDK, entopts map[string]any) *ArrivalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArrivalEntity) GetName() string { return e.name }
...
func (e *ArrivalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArrivalEntity) Deleted() bool {
	return e.deleted
}


func (e *ArrivalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArrivalEntity(e.client, opts)
}

func (e *ArrivalEntity) Data(args ...any) any {
...
func (e *ArrivalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Arrival; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArrivalEntity) DataTyped(data ...Arrival) Arrival {
	if len(data) > 0 {
		return typedFrom[Arrival](e.Data(asMap(data[0])))
	}
	return typedFrom[Arrival](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Arrival (all fields
// optional at the wire level).
func (e *ArrivalEntity) MatchTyped(match ...Arrival) Arrival {
	if len(match) > 0 {
		return typedFrom[Arrival](e.Match(asMap(match[0])))
	}
	return typedFrom[Arrival](e.Match())
}
...
func (e *ArrivalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArrivalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ArrivalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArrivalListMatch and returns []Arrival. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArrivalEntity) ListTyped(reqmatch ArrivalListMatch, ctrl map[string]any) ([]Arrival, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Arrival](res), nil
}



func (e *ArrivalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArrivalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArrivalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArrivalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
