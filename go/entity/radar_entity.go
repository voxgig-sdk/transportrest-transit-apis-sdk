...
func NewRadarEntity(client *core.TransportrestTransitApisSDK, entopts map[string]any) *RadarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RadarEntity) GetName() string { return e.name }
...
func (e *RadarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RadarEntity) Deleted() bool {
	return e.deleted
}


func (e *RadarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRadarEntity(e.client, opts)
}

func (e *RadarEntity) Data(args ...any) any {
...
func (e *RadarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Radar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RadarEntity) DataTyped(data ...Radar) Radar {
	if len(data) > 0 {
		return typedFrom[Radar](e.Data(asMap(data[0])))
	}
	return typedFrom[Radar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Radar (all fields
// optional at the wire level).
func (e *RadarEntity) MatchTyped(match ...Radar) Radar {
	if len(match) > 0 {
		return typedFrom[Radar](e.Match(asMap(match[0])))
	}
	return typedFrom[Radar](e.Match())
}
...
func (e *RadarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RadarEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RadarEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RadarListMatch and returns []Radar. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RadarEntity) ListTyped(reqmatch RadarListMatch, ctrl map[string]any) ([]Radar, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Radar](res), nil
}



func (e *RadarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RadarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RadarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RadarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
