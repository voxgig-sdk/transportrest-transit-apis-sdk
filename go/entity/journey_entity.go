...
func NewJourneyEntity(client *core.TransportrestTransitApisSDK, entopts map[string]any) *JourneyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JourneyEntity) GetName() string { return e.name }
...
func (e *JourneyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JourneyEntity) Deleted() bool {
	return e.deleted
}


func (e *JourneyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJourneyEntity(e.client, opts)
}

func (e *JourneyEntity) Data(args ...any) any {
...
func (e *JourneyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Journey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JourneyEntity) DataTyped(data ...Journey) Journey {
	if len(data) > 0 {
		return typedFrom[Journey](e.Data(asMap(data[0])))
	}
	return typedFrom[Journey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Journey (all fields
// optional at the wire level).
func (e *JourneyEntity) MatchTyped(match ...Journey) Journey {
	if len(match) > 0 {
		return typedFrom[Journey](e.Match(asMap(match[0])))
	}
	return typedFrom[Journey](e.Match())
}
...
func (e *JourneyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JourneyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *JourneyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JourneyListMatch and returns []Journey. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *JourneyEntity) ListTyped(reqmatch JourneyListMatch, ctrl map[string]any) ([]Journey, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Journey](res), nil
}



func (e *JourneyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JourneyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JourneyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JourneyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
