...
const testSeed = `map[string]any{"entity": map[string]any{"arrival": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "departure": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "journey": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "radar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stop": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trip": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
