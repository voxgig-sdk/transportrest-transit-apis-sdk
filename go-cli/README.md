...
AQL-driven CLI and REPL for the TransportrestTransitApis SDK. Positional arguments are
...
```sh
go build -o transportrest-transit-apis-cli ./...
```
...
./transportrest-transit-apis-cli load 1 arrival
./transportrest-transit-apis-cli load '{id:1}' arrival
