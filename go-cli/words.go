...
func registerSDKWords(r *eng.Registry, client *sdk.TransportrestTransitApisSDK) {
...
func runOp(client *sdk.TransportrestTransitApisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
