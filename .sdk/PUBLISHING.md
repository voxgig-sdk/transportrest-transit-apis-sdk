...
|---|---|---|
| `ts/` | @voxgig-sdk/transportrest-transit-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/transportrest-transit-apis-sdk \
      --repository voxgig-sdk/transportrest-transit-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/transportrest-transit-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/transportrest-transit-apis-sdk --id=<id>` removes it.
