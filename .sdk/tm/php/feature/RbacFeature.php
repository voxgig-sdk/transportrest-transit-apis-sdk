...
// TransportrestTransitApis SDK rbac feature
...
class TransportrestTransitApisRbacFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _required(TransportrestTransitApisContext $ctx): ?string
    {
    ...
    private function _reject(TransportrestTransitApisContext $ctx, string $required): void
    {
    ...
    private function _track(TransportrestTransitApisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
