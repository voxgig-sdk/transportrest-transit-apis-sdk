...
// TransportrestTransitApis SDK proxy feature
...
class TransportrestTransitApisProxyFeature extends TransportrestTransitApisBaseFeature
{
    ...
    public function init(TransportrestTransitApisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TransportrestTransitApisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
