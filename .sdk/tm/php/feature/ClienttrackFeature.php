...
// TransportrestTransitApis SDK clienttrack feature
...
class TransportrestTransitApisClienttrackFeature extends TransportrestTransitApisBaseFeature
{
    ...
    public function PostConstruct(TransportrestTransitApisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TransportrestTransitApis-SDK';
