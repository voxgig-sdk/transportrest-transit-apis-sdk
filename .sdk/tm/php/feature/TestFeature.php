...
// TransportrestTransitApis SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TransportrestTransitApisTestFeature extends TransportrestTransitApisBaseFeature
{
    ...
    public function init(TransportrestTransitApisContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TransportrestTransitApisContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TransportrestTransitApisParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TransportrestTransitApisContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TransportrestTransitApisContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = TransportrestTransitApisParam::call($ctx, $k);
