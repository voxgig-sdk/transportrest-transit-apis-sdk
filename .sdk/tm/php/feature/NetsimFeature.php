...
// TransportrestTransitApis SDK netsim feature
...
class TransportrestTransitApisNetsimFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _simulate(TransportrestTransitApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TransportrestTransitApisContext $ctx, array $applied): void
    {
        $client = $this->client;
