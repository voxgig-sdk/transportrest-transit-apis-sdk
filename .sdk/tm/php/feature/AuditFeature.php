...
// TransportrestTransitApis SDK audit feature
...
class TransportrestTransitApisAuditFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _emit(TransportrestTransitApisContext $ctx, string $outcome): void
    {
