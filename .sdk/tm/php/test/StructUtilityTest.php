...
// TransportrestTransitApis SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TransportrestTransitApisOmni::makeStructRunner(
    ...
    {
        return TransportrestTransitApisOmni::objmodel(TransportrestTransitApisOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return TransportrestTransitApisOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return TransportrestTransitApisOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TransportrestTransitApisOmni::structfix($now, Struct::undef()))
                        !== json_encode(TransportrestTransitApisOmni::structfix($val, Struct::undef()))) {
