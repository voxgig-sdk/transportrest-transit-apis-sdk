...
// TransportrestTransitApis SDK pipeline test
//
...
{
    private static function utility(): TransportrestTransitApisUtility
    {
        return new TransportrestTransitApisUtility();
    }
    ...
    private static function ctx(array $over = []): TransportrestTransitApisContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TransportrestTransitApisContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TransportrestTransitApisError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TransportrestTransitApisMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TransportrestTransitApisMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TransportrestTransitApisMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TransportrestTransitApisSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TransportrestTransitApisMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TransportrestTransitApisResponse([]),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        [, $err] = TransportrestTransitApisMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec([]),
            'response' => null,
            'result' => new TransportrestTransitApisResult([]),
        ]);
        [, $err] = TransportrestTransitApisMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec(['step' => 's']),
            'response' => new TransportrestTransitApisResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        [, $err] = TransportrestTransitApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec(['step' => 's']),
            'response' => new TransportrestTransitApisResponse(self::resp(200, ['v' => 1])),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        [, $err] = TransportrestTransitApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec(['step' => 's']),
            'response' => new TransportrestTransitApisResponse(self::resp(200, ['v' => 2])),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TransportrestTransitApisMakeResponse::call($ctx);
    ...
    {
        $preset = new TransportrestTransitApisResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec([]),
            'response' => new TransportrestTransitApisResponse([]),
            'result' => new TransportrestTransitApisResult([]),
        ...
        [$got, $err] = TransportrestTransitApisMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TransportrestTransitApisResult([])]);
        [, $err] = TransportrestTransitApisMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TransportrestTransitApisSpec([]), 'result' => null]);
        [, $err] = TransportrestTransitApisMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TransportrestTransitApisSpec(['step' => 's']),
            'result' => new TransportrestTransitApisResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TransportrestTransitApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TransportrestTransitApisSpec(['step' => 's']),
            'result' => new TransportrestTransitApisResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TransportrestTransitApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TransportrestTransitApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TransportrestTransitApisResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TransportrestTransitApisSpec([]),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TransportrestTransitApisMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TransportrestTransitApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TransportrestTransitApisError('boom', 'boom');
        $utility->fetcher = function (TransportrestTransitApisContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TransportrestTransitApisSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TransportrestTransitApisMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TransportrestTransitApisContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TransportrestTransitApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TransportrestTransitApisResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TransportrestTransitApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TransportrestTransitApisContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TransportrestTransitApisSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TransportrestTransitApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TransportrestTransitApisResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TransportrestTransitApisSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TransportrestTransitApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TransportrestTransitApisMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TransportrestTransitApisMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TransportrestTransitApisResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TransportrestTransitApisDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TransportrestTransitApisResult(['ok' => false])]);
        $this->expectException(TransportrestTransitApisError::class);
        TransportrestTransitApisDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TransportrestTransitApisResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TransportrestTransitApisMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TransportrestTransitApisMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TransportrestTransitApisBaseFeature();
        $b = new TransportrestTransitApisBaseFeature();
        TransportrestTransitApisFeatureAdd::call($ctx, $a);
        TransportrestTransitApisFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TransportrestTransitApisBaseFeature
    {
        $f = new TransportrestTransitApisBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TransportrestTransitApisFeatureAdd::call($ctx, self::named_feature('a'));
        TransportrestTransitApisFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TransportrestTransitApisFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TransportrestTransitApisFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TransportrestTransitApisFeatureAdd::call($ctx, $replace);
        ...
        TransportrestTransitApisFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TransportrestTransitApisContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TransportrestTransitApisSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TransportrestTransitApisPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TransportrestTransitApisPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TransportrestTransitApisResponse(['headers' => null]),
            'result' => new TransportrestTransitApisResult([]),
        ]);
        TransportrestTransitApisResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TransportrestTransitApisResultBody::call($ctx);
