...
// TransportrestTransitApis SDK utility: graphql
//
...
class TransportrestTransitApisGraphql
{
    ...
    // equivalent.
    public static function body(TransportrestTransitApisContext $ctx): mixed
    {
    ...
    public static function errors(TransportrestTransitApisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
