...
// TransportrestTransitApis SDK utility: make_options

class TransportrestTransitApisMakeOptions
{
    ...
    public static function call(TransportrestTransitApisContext $ctx): array
    {
        ...
        //
        // `TransportrestTransitApisSchema::optspec()` is built from the model:
        ...
        $optspec = TransportrestTransitApisSchema::optspec();
