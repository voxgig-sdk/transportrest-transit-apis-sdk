...
exports.JourneyEntity = void 0;
const TransportrestTransitApisEntityBase_1 = require("../TransportrestTransitApisEntityBase");
// TODO: needs Entity superclass
class JourneyEntity extends TransportrestTransitApisEntityBase_1.TransportrestTransitApisEntityBase {
    ...
    make() {
        return new JourneyEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Journey[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=JourneyEntity.js.map