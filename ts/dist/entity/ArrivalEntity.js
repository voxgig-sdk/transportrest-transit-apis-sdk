...
class ArrivalEntity extends TransportrestTransitApisEntityBase_1.TransportrestTransitApisEntityBase {
    ...
    make() {
        return new ArrivalEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Arrival[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.ArrivalEntity = ArrivalEntity;
//# sourceMappingURL=ArrivalEntity.js.map