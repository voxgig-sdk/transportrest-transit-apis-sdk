...
const TransportrestTransitApisError_1 = require("./TransportrestTransitApisError");
...
class Context {
    ...
    error(code, msg) {
        return new TransportrestTransitApisError_1.TransportrestTransitApisError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
