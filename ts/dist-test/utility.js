...
function envOverride(m) {
    if ('TRUE' === process.env.TRANSPORTREST_TRANSIT_APIS_TEST_LIVE ||
        'TRUE' === process.env.TRANSPORTREST_TRANSIT_APIS_TEST_OVERRIDE) {
    ...
    m.TRANSPORTREST_TRANSIT_APIS_TEST_EXPLAIN = process.env.TRANSPORTREST_TRANSIT_APIS_TEST_EXPLAIN || m.TRANSPORTREST_TRANSIT_APIS_TEST_EXPLAIN;
    return m;
}
