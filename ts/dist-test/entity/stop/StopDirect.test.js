...
(0, node_test_1.describe)('StopDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-stop', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stop', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = "900000003201";
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'TRANSPORTREST_TRANSIT_APIS_TEST_STOP_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['TRANSPORTREST_TRANSIT_APIS_TEST_STOP_ENTID'];
...
//# sourceMappingURL=StopDirect.test.js.map