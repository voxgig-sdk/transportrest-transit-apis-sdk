...
(0, node_test_1.describe)('RadarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-radar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-radar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRANSPORTREST_TRANSIT_APIS_TEST_RADAR_ENTID'];
...
//# sourceMappingURL=RadarDirect.test.js.map