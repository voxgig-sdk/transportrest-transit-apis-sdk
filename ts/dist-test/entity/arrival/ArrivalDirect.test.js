...
(0, node_test_1.describe)('ArrivalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TransportrestTransitApisSDK({
    ...
    (0, node_test_1.test)('direct-list-arrival', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-arrival', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["stop01"]))
            return;
...
function liveScenariosActive() { return false && process.env.TRANSPORTREST_TRANSIT_APIS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TransportrestTransitApisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TRANSPORTREST_TRANSIT_APIS_TEST_ARRIVAL_ENTID'];
    ...
    const client = new __1.TransportrestTransitApisSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ArrivalDirect.test.js.map