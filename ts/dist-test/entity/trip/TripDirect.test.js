...
(0, node_test_1.describe)('TripDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-trip', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trip', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRANSPORTREST_TRANSIT_APIS_TEST_TRIP_ENTID'];
...
//# sourceMappingURL=TripDirect.test.js.map