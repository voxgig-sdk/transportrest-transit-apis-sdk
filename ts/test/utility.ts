...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TRANSPORTRESTTRANSITAPIS_TEST_LIVE ||
    'TRUE' === process.env.TRANSPORTRESTTRANSITAPIS_TEST_OVERRIDE
  ) {
  ...
  m.TRANSPORTRESTTRANSITAPIS_TEST_EXPLAIN = process.env.TRANSPORTRESTTRANSITAPIS_TEST_EXPLAIN || m.TRANSPORTRESTTRANSITAPIS_TEST_EXPLAIN
