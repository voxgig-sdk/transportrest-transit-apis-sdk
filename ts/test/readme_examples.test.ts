...
//     (\`new TransportrestTransitApisSDK(...)\` / \`TransportrestTransitApisSDK.test(...)\` become
//     \`TransportrestTransitApisSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'TransportrestTransitApisSDK'
...
const TEST_SEED = {"entity":{"arrival":{"test01":{"id":"test01"}},"departure":{"test01":{"id":"test01"}},"journey":{"test01":{"id":"test01"}},"location":{"test01":{"id":"test01"}},"radar":{"test01":{"id":"test01"}},"stop":{"test01":{"id":"test01"}},"trip":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new TransportrestTransitApisSDK(...)\` and any
// \`TransportrestTransitApisSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+TransportrestTransitApisSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/TransportrestTransitApisSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
