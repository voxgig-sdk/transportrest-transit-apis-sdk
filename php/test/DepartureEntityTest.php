...
class DepartureEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TRANSPORTREST_TRANSIT_APIS_TEST_DEPARTURE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function departure_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TRANSPORTREST_TRANSIT_APIS_TEST_DEPARTURE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["TRANSPORTREST_TRANSIT_APIS_TEST_DEPARTURE_ENTID"]);
