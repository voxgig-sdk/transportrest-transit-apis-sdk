...
class RadarDirectTest extends TestCase
{
    public function test_direct_list_radar(): void
    {
        $setup = radar_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-radar", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
