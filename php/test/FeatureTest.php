...
// TransportrestTransitApis SDK feature test
//
...
class FtCtrl extends TransportrestTransitApisControl
{
...
class FtClient
{
    ...
    private TransportrestTransitApisUtility $utility;

    public function __construct(TransportrestTransitApisUtility $utility, array $options)
    {
    ...
    public function get_utility(): TransportrestTransitApisUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (TransportrestTransitApisContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public TransportrestTransitApisContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (TransportrestTransitApisContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = TransportrestTransitApisConfig::make_feature($name);
    ...
    private static function buildUrl(TransportrestTransitApisSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof TransportrestTransitApisError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new TransportrestTransitApisResponse($fetched);
        }
    ...
    private function fail(TransportrestTransitApisContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (TransportrestTransitApisContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
