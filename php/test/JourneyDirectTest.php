...
class JourneyDirectTest extends TestCase
{
    public function test_direct_list_journey(): void
    {
        $setup = journey_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-journey", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
