...
// TransportrestTransitApis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TransportrestTransitApisSDK::test)
...
{
    private const SDK_CLASS = 'TransportrestTransitApisSDK';
    ...
    private const SDK_BASE = 'transportresttransitapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../transportresttransitapis_sdk.php';
