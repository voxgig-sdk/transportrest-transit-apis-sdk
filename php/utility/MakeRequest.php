...
// TransportrestTransitApis SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TransportrestTransitApisMakeRequest
{
    public static function call(TransportrestTransitApisContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TransportrestTransitApisResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TransportrestTransitApisResponse($fetched);
        } else {
