...
// TransportrestTransitApis SDK utility: fetcher

class TransportrestTransitApisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TransportrestTransitApisSDK/1.0)';
    ...
    public static function call(TransportrestTransitApisContext $ctx, string $fullurl, array $fetchdef): array
    {
