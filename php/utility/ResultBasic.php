...
// TransportrestTransitApis SDK utility: result_basic

class TransportrestTransitApisResultBasic
{
    public static function call(TransportrestTransitApisContext $ctx): ?TransportrestTransitApisResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TransportrestTransitApisError) ? $result->err->msg : (string)$result->err;
