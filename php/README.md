...
The PHP SDK for the TransportrestTransitApis API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Arrival(null)->list(null, null);
...
[$result, $err] = $client->TransportrestTransitApis(null)->load(
    ["id" => "test01"], null
);
