...
// TransportrestTransitApis SDK Journey entity
...
class JourneyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new JourneyEntity($this->_client, $opts);
    }

    /**
     * @param Journey|array $args Journey data (assoc-array) to store.
     */
    ...
    /**
     * @return Journey|array The current Journey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Journey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Journey fields).
     */
    ...
    /**
     * List Journey items matching the given filter.
     *
     * @param JourneyListMatch|array|null $reqmatch Match filter (any subset
     *   of Journey fields) as an assoc-array; JourneyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Journey[]|array A list of Journey items as assoc-arrays at
