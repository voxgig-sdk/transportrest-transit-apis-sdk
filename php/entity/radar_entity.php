...
// TransportrestTransitApis SDK Radar entity
...
class RadarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RadarEntity($this->_client, $opts);
    }

    /**
     * @param Radar|array $args Radar data (assoc-array) to store.
     */
    ...
    /**
     * @return Radar|array The current Radar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Radar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Radar fields).
     */
     ...
     *
     * @param RadarListMatch|array|null $reqmatch Match filter (any subset
     *   of Radar fields) as an assoc-array; RadarListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Radar[]|array A list of Radar items as assoc-arrays at
