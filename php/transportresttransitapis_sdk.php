...
class TransportrestTransitApisSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = TransportrestTransitApisHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = TransportrestTransitApisHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!TransportrestTransitApisFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, TransportrestTransitApisFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return TransportrestTransitApisUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = TransportrestTransitApisHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = TransportrestTransitApisHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = TransportrestTransitApisHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new TransportrestTransitApisError($op . "_allow",
                "TransportrestTransitApisSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = TransportrestTransitApisHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new TransportrestTransitApisError("graphql_error",
                "TransportrestTransitApisSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Arrival($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_arrival === null) {
                $this->_arrival = new ArrivalEntity($this, null);
            }
            return $this->_arrival;
        }
        return new ArrivalEntity($this, $data);
    }
    ...
    public function Journey($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_journey === null) {
                $this->_journey = new JourneyEntity($this, null);
            }
            return $this->_journey;
        }
        return new JourneyEntity($this, $data);
    }
    ...
    public function Radar($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_radar === null) {
                $this->_radar = new RadarEntity($this, null);
            }
            return $this->_radar;
        }
        return new RadarEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new TransportrestTransitApisSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
