...
// TransportrestTransitApis SDK timeout feature
...
class TransportrestTransitApisTimeoutFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _with_timeout(TransportrestTransitApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TransportrestTransitApisContext $_ctx, float $ms): void
    {
        $client = $this->client;
