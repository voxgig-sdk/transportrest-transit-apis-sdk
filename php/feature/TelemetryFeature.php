...
// TransportrestTransitApis SDK telemetry feature
...
class TransportrestTransitApisTelemetryFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _close(TransportrestTransitApisContext $ctx, bool $ok): void
    {
