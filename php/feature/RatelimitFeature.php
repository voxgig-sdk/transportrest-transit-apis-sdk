...
// TransportrestTransitApis SDK ratelimit feature
...
class TransportrestTransitApisRatelimitFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _acquire(TransportrestTransitApisContext $ctx): void
    {
    ...
    private function _track(TransportrestTransitApisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
