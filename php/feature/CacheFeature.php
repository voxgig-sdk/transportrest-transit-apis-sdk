...
// TransportrestTransitApis SDK cache feature
...
class TransportrestTransitApisCacheFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _through(TransportrestTransitApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
