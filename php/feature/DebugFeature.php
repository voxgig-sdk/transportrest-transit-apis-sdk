...
// TransportrestTransitApis SDK debug feature
...
class TransportrestTransitApisDebugFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _finish(TransportrestTransitApisContext $ctx, bool $ok): void
    {
