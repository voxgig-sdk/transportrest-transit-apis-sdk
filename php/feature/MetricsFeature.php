...
// TransportrestTransitApis SDK metrics feature
...
class TransportrestTransitApisMetricsFeature extends TransportrestTransitApisBaseFeature
{
    ...
    private function _record(TransportrestTransitApisContext $ctx, bool $ok): void
    {
