...
// TransportrestTransitApis SDK utility type

class TransportrestTransitApisUtility
{
    ...
    public static function copy(TransportrestTransitApisUtility $src): TransportrestTransitApisUtility
    {
        $u = new TransportrestTransitApisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
