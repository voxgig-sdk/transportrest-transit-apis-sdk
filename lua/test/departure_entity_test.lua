...
describe("DepartureEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TRANSPORTREST_TRANSIT_APIS_TEST_DEPARTURE_ENTID JSON to run live")
      return
    end
...
function departure_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TRANSPORTREST_TRANSIT_APIS_TEST_DEPARTURE_ENTID")
