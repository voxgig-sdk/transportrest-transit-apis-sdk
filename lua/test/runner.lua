...
function runner.env_override(m)
  local live = runner.getenv("TRANSPORTRESTTRANSITAPIS_TEST_LIVE")
  local override = runner.getenv("TRANSPORTRESTTRANSITAPIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRANSPORTRESTTRANSITAPIS_TEST_EXPLAIN")
