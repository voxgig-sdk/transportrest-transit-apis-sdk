...
function runner.env_override(m)
  local live = runner.getenv("TRANSPORTREST_TRANSIT_APIS_TEST_LIVE")
  local override = runner.getenv("TRANSPORTREST_TRANSIT_APIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRANSPORTREST_TRANSIT_APIS_TEST_EXPLAIN")
