...
describe("JourneyDirect", function()
  it("should direct-list-journey", function()
    local setup = journey_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-journey", setup.live and "live" or "unit")
...
function journey_direct_setup(mockres)
