...
describe("RadarDirect", function()
  it("should direct-list-radar", function()
    local setup = radar_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-radar", setup.live and "live" or "unit")
...
function radar_direct_setup(mockres)
