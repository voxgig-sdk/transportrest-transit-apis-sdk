...
local SDK_MODULE = "transportrest-transit-apis_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["arrival"] = { ["test01"] = { id = "test01" } }, ["departure"] = { ["test01"] = { id = "test01" } }, ["journey"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } }, ["radar"] = { ["test01"] = { id = "test01" } }, ["stop"] = { ["test01"] = { id = "test01" } }, ["trip"] = { ["test01"] = { id = "test01" } } } }'
