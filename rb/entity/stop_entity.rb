...
class StopEntity
  ...
  # @return [Stop, Hash] the loaded Stop; raises TransportrestTransitApisError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = TransportrestTransitApisHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
