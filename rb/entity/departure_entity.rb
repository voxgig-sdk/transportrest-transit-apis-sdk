# TransportrestTransitApis SDK Departure entity
...
class DepartureEntity
  ...
  # @return [Array<Departure>, Array] the matching Departure items; raises TransportrestTransitApisError on failure
