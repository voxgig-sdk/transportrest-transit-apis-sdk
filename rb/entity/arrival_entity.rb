...
class ArrivalEntity
  ...
  def make
    opts = @_entopts.dup
    ArrivalEntity.new(@_client, opts)
  end
  ...
  # @return [Arrival, Hash] the current Arrival data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Arrival fields)
  def match_get
  ...
  #
  # @param reqmatch [ArrivalListMatch, Hash, nil] match filter (any subset of
  #   Arrival fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Arrival>, Array] the matching Arrival items; raises TransportrestTransitApisError on failure
