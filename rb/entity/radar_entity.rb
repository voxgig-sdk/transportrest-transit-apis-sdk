...
class RadarEntity
  ...
  #
  # @param reqmatch [RadarListMatch, Hash, nil] match filter (any subset of
  #   Radar fields); defaults to nil, treated as an empty match that lists all.
