...
#      offline in seeded test mode (TransportrestTransitApisSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TransportrestTransitApis_sdk.rb")
  SDK_CLASS = "TransportrestTransitApisSDK"
  ...
  SDK_BASE = "TransportrestTransitApis_sdk"
