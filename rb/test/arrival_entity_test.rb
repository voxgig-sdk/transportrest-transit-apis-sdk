...
class ArrivalEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TRANSPORTRESTTRANSITAPIS_TEST_ARRIVAL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def arrival_basic_setup(extra)
  ...
  entid_env_raw = ENV["TRANSPORTRESTTRANSITAPIS_TEST_ARRIVAL_ENTID"]
