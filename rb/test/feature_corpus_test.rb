# TransportrestTransitApis SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # TransportrestTransitApisSDK.new, not TransportrestTransitApisSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    TransportrestTransitApisSDK.new(opts)
  end
