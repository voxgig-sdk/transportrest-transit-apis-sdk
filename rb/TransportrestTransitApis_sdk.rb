...
class TransportrestTransitApisSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = TransportrestTransitApisHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = TransportrestTransitApisHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, TransportrestTransitApisFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    TransportrestTransitApisUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    params = TransportrestTransitApisHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = TransportrestTransitApisHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => TransportrestTransitApisError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = TransportrestTransitApisHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = TransportrestTransitApisError.new(
        "graphql_error", "TransportrestTransitApisSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = TransportrestTransitApisSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
