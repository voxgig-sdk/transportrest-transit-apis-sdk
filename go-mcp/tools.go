...
type Args struct {
	Entity string         `json:"entity" jsonschema:"arrival | departure | journey | location | radar | stop | trip"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TransportrestTransitApisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "transportrest-transit-apis_list",
		Description: "List records from TransportrestTransitApis. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "transportrest-transit-apis_load",
		Description: "Load a single record from TransportrestTransitApis. " +
...
func runOp(client *sdk.TransportrestTransitApisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TransportrestTransitApisSDK, name string) (sdk.TransportrestTransitApisEntity, error) {
	switch strings.ToLower(name) {
	case "arrival":
		return client.Arrival(nil), nil
	case "departure":
		return client.Departure(nil), nil
	case "journey":
		return client.Journey(nil), nil
	case "location":
		return client.Location(nil), nil
	case "radar":
		return client.Radar(nil), nil
	case "stop":
