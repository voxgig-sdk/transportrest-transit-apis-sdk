// Command TransportrestTransitApis-mcp is an MCP server exposing the TransportrestTransitApis
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TransportrestTransitApis_list  — list records of an entity
//	TransportrestTransitApis_load  — load a single record of an entity
//
